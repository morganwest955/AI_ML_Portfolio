...
""" % (prereq, q, q, prereq)
    ...
    posBonus = 2
    print "Style Points: ?/%d" % (posBonus)
    print '------------------'
    print 'Total: %d/%d (%d/%d excluding style)' % (self.points.totalCount(), sum(self.maxes.values())+posBonus,self.points.totalCount(), sum(self.maxes.values()))
